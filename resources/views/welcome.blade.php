...
@section('content')
      ...
      <div class="flex flex-wrap items-center -mx-4">
        <div class="w-full px-4">
          <div class="hero-content text-center max-w-[780px] mx-auto wow fadeInUp" data-wow-delay=".2s">
            <h1 class="text-white font-bold text-3xl sm:text-4xl md:text-[45px] leading-snug sm:leading-snug md:leading-snug mb-8">
              Desenvolvimento de Habbos
            </h1>
            <p class="text-base sm:text-lg sm:leading-relaxed md:text-xl md:leading-relaxed mx-auto mb-10 text-[#e4e4e4] max-w-[600px]">
              Desde instalações e configurações completas,
              até criações de sistemas próprios para seu server.
            </p>
            <ul class="flex flex-wrap items-center justify-center mb-10">
              <li>
                <a href="https://api.whatsapp.com/send/?phone=13155122348&text=Eu+tenho+interesse+no+seu+servi%C3%A7o&app_absent=0" target="_blank" class="py-4 px-6 sm:px-10 inline-flex items-center justify-center text-center text-dark text-base bg-white hover:text-primary hover:shadow-lg font-medium rounded-lg transition duration-300 ease-in-out">
                  Contate-nos
                </a>
              </li>
              <li>
                <a href="https://discord.com/invite/YDmbap49bJ" target="_blank" class="text-base font-medium text-white py-4 px-6 sm:px-10 flex items-center hover:opacity-70 transition duration-300 ease-in-out">
                  Discord
                  <span class="pl-2">
            ...
            <div class="flex justify-center">
              <img src="{{ asset('assets/images/hero/nitrohtml5.png') }}" alt="image" width="250" height="250" class="ml-4 opacity-50 hover:opacity-100 transition duration-300 ease-in-out"/>
              <img src="{{ asset('assets/images/hero/arcturusmorningstar.jpg') }}" alt="image" width="250" height="250" class="mr-4 opacity-50 hover:opacity-100 transition duration-300 ease-in-out" style="margin-top: 70px; margin-right: 50px;"/>
            </div>
          </div>
        </div>
        ...
        <div class="w-full px-4">
          <div class="mx-auto max-w-[845px] relative z-10 wow fadeInUp" data-wow-delay=".25s">
            <div class="mt-16">
              <img src="{{ asset('assets/images/hero/nitroserver.png') }}" alt="hero" class="max-w-full mx-auto rounded-t-xl rounded-tr-xl"/>
            </div>
  ...
  <section id="services" class="pt-20 lg:pt-[120px] pb-8 lg:pb-[70px]">
    <div class="container">
        ...
        <div class="w-full px-4">
          <div class="mb-12 lg:mb-20 max-w-[620px]">
            ...
            <p class="text-lg sm:text-xl leading-relaxed sm:leading-relaxed text-body-color">
              Oferecemos desde instalações e configurações completas,
              até criações, atualizações e personalizações no seu servidor.
            </p>
          </div>
        </div>
      </div>
      <div class="flex flex-wrap -mx-4">
        <div class="w-full md:w-1/2 lg:w-1/4 px-4">
          <div class="bg-white mb-12 group wow fadeInUp" data-wow-delay=".1s">
            ...
            <p class="text-body-color mb-8 lg:mb-11">
              Instalação e configuração completa do servidor.
            </p>
            <a href="#pricing" class="font-medium text-base text-body-color hover:text-primary">
              Saiba Mais
            </a>
          </div>
        </div>
        <div class="w-full md:w-1/2 lg:w-1/4 px-4">
          <div class="bg-white mb-12 group wow fadeInUp" data-wow-delay=".15s">
            <div class=" w-[70px] h-[70px] flex items-center justify-center bg-primary rounded-2xl mb-8 relative z-10">
              <span class="w-[70px] h-[70px] flex items-center justify-center bg-primary bg-opacity-20 rounded-2xl mb-8 absolute z-[-1] top-0 left-0 rotate-[25deg] group-hover:rotate-45 duration"></span>
              <svg width="35" height="35" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class="text-body-color mb-8 lg:mb-11">
              Faremos o sistema de acordo com os seus critérios.
            </p>
        ...
        <div class="w-full md:w-1/2 lg:w-1/4 px-4">
          <div class="bg-white mb-12 group wow fadeInUp" data-wow-delay=".2s">
            ...
            <p class="text-body-color mb-8 lg:mb-11">
              Diversos opcionais para turbirnar seu servidor Habbo.
            </p>
            <a href="javascript:void(0)" class="font-medium text-base text-body-color hover:text-primary">
              Saiba Mais
            </a>
        ...
        <div class="w-full md:w-1/2 lg:w-1/4 px-4">
          <div class="bg-white mb-12 group wow fadeInUp" data-wow-delay=".25s">
            ...
            <p class="text-body-color mb-8 lg:mb-11">
              Diversas máquinas pré-montadas e com upgrades.
            </p>
            <a href="javascript:void(0)" class="font-medium text-base text-body-color hover:text-primary">
              Saiba Mais
            </a>
            ...
            <div class="lg:flex items-center justify-between border overflow-hidden">
              <div class="lg:max-w-[565px] xl:max-w-[640px] w-full py-12 px-7 sm:px-12 md:p-16 lg:py-9 lg:px-16 xl:p-[70px]">
                ...
                <p class="text-base text-body-color mb-9 leading-relaxed">
                  A DevHabbos é uma comunidade focada no mundo 
                  virtual do jogo Habbo. Focamos em ajudar e 
                  auxiliar a comunidade Brasileira e Portuguêsa 
                  em seus servidores.
                </p>
                <p class="text-base text-body-color mb-9 leading-relaxed">
                  Além de ajudar toda a comunidade, oferecemos 
                  diversos serviços caso você não saiba como 
                  faze-lo ou não tenha interesse de ter o trabalho!
                </p>
                <a href="javascript:void(0)" class="inline-flex items-center justify-center py-4 px-6 rounded text-white bg-secondary text-base font-medium hover:bg-opacity-90 hover:shadow-lg transition duration-300 ease-in-out">
                  Servidores
                </a>
    ...
    <div class="container">
        ...
        <div class="w-full px-4">
          <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[620px]">
            ...
            <h2 class="font-bold text-3xl sm:text-4xl md:text-[40px] text-dark mb-4">
              Servidores Pré-Montados
            </h2>
            <p class="text-lg sm:text-xl leading-relaxed sm:leading-relaxed text-body-color">
              Temos algumas opções de servidores já pré-
              montados a disposição para serem instalados em sua máquina.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="flex flex-wrap items-center justify-center">
        ...
        @foreach ($habbos as $habbo)
          @if ($habbo->language == 'Idioma Inglês')
        ...
        @foreach ($habbos as $habbo)
          @if ($habbo->slug == 'servidor-pt-atom-cms')
            <div class="w-full md:w-1/2 lg:w-1/3">
        ...
        @foreach ($habbos as $habbo)
          @if ($habbo->slug == 'servidor-em-portugues')
            <div class="w-full md:w-1/2 lg:w-1/3">
              <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10 px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-10 text-center wow fadeInUp" data-wow-delay=".15s">
                <span class="text-dark font-medium text-base uppercase block mb-2">
                  {{ $habbo->name }}
  ...
  <section id="faq" class="bg-[#f3f4ff] pt-20 lg:pt-[120px] pb-12 lg:pb-[90px] relative z-20 overflow-hidden">
    <div class="container">
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4">
          <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[620px]">
            ...
            <p class="text-lg sm:text-xl leading-relaxed sm:leading-relaxed text-body-color">
              Algumas das maiores dúvidas de nossos clientes estão aqui.
              Quem sabe a sua dúvida também pode ser tirada logo abaixo...
            </p>
          </div>
        </div>
      </div>
